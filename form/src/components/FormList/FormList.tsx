...
const FormList: React.FC = () => {
  ...
  const handleEditForm = (form: FormConfiguration) => {
    ...
    // You might want to switch to the Form Builder tab here
  };
    ...
    return (
      <Box sx={{ textAlign: 'center', py: 4 }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>
          Go to the Form Builder tab to create your first form
        </Typography>
      </Box>
    );
  }
    ...
    <Box>
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body1" color="text.secondary" paragraph>
          Manage your form configurations. You can edit, duplicate, or delete forms from here.
        </Typography>
